...
class TypeProductController{
    ...
    @CrossOrigin(origins = "http://localhost:4200")
    public ResponseEntity<Map<String, Object>> typeproductSumbit(@PathVariable("id") Long id,@PathVariable("nametype")String nametype) {
        try {
           ...
           this.typeProductRepository.save(t);
